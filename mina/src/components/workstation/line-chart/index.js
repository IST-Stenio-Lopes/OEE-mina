...
console.log(props.production_per_hour)
        this.state = {
            ...
            series: [
                ...
                {
                    name: "RETRABALHO",
                    data: [808,  468,  726,  355,  335,  769,  890,  654,  864,  326,  652,  423,  537,  449,  729,  823,  584,  692,  499,  200,  985,  161,  193,  257],
                    color: '#C66B00'
                    
                },
                {
                    name: "REFUGO",
                    data: [259, 290, 493,  92, 486, 131, 689, 256, 304, 434, 602, 257, 281, 507, 568, 405, 363, 570, 689, 554, 381, 324, 668, 348],
                    color: '#C02B2B'
                }
            ],
            options: {
                ...
                xaxis: {
                    type: 'category',
                    categories: ['0h', '1h', '2h', '3h', '4h', '5h', '6h', '7h', '8h', '9h', '10h', '11h', '12h', '13h', '14h', '15h', '16h', '17h', '18h', '19h', '20h', '21h', '22h', '23h', '24h', '25h', '26h', '27h'],
                }
            },
